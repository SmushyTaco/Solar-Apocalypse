...
object HeatOverlayFadeInAndOutLogic {
    fun ClientPlayerEntity.hookTick(value: Float, time: Double, day: Double): Float {
        ...
        val should = world.isOldEnough(day) && isAlive && !world.isRaining && !isSpectator && !isCreative && !world.isNight && (world.isSkyVisible(blockPos) || shouldHeatLayerDamage(world)) && !hasStatusEffect(sunscreen)
