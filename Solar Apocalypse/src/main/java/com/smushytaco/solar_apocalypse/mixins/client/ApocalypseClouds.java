...
public abstract class ApocalypseClouds {
    @WrapOperation(method = "renderClouds", at = @At(value = "INVOKE", target="Lcom/mojang/blaze3d/buffers/Std140Builder;putVec4(FFFF)Lcom/mojang/blaze3d/buffers/Std140Builder;", ordinal = 0))
