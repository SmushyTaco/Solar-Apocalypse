...
public abstract class BigSun {
    ...
    private VertexConsumer hookRenderSkyVertexOne(BufferBuilder instance, Matrix4f matrix, float x, float y, float z, Operation<VertexConsumer> original) { return Render.INSTANCE.bigSunGenerator(instance, matrix, x, y, z, original); }
    ...
    private VertexConsumer hookRenderSkyVertexTwo(BufferBuilder instance, Matrix4f matrix, float x, float y, float z, Operation<VertexConsumer> original) { return Render.INSTANCE.bigSunGenerator(instance, matrix, x, y, z, original); }
    ...
    private VertexConsumer hookRenderSkyVertexThree(BufferBuilder instance, Matrix4f matrix, float x, float y, float z, Operation<VertexConsumer> original) { return Render.INSTANCE.bigSunGenerator(instance, matrix, x, y, z, original); }
    ...
    private VertexConsumer hookRenderSkyVertexFour(BufferBuilder instance, Matrix4f matrix, float x, float y, float z, Operation<VertexConsumer> original) { return Render.INSTANCE.bigSunGenerator(instance, matrix, x, y, z, original); }
}